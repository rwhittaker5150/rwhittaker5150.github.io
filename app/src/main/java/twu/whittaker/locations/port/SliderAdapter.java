...
public class SliderAdapter extends PagerAdapter {
    ...
    private int[] lst_images = {
            R.drawable.porto,
            R.drawable.douro_valley,
            R.drawable.guimaraes,
            R.drawable.braga,
            R.drawable.viana_do_castelo
    };
    ...
    private int[] lst_description = {
            R.string.port_description,
            R.string.duo_description,
            R.string.gui_description,
            R.string.bra_description,
            R.string.via_description
