...
public class SliderAdapter extends PagerAdapter {
    ...
    private int[] lst_images = {
            ...
            R.drawable.kerala,
            R.drawable.varanasi,
            R.drawable.ellora_and_ajanta_caves
    };
    ...
    private int[] lst_description = {
            R.string.ra_description,
            R.string.ag_description,
            R.string.ker_description,
            R.string.var_description,
            R.string.mah_description
    ...
    private int lst_contact = R.string.india_contact;
    private int title = R.string.in_label;
