...
public class SliderAdapter extends PagerAdapter {
    ...
    private int[] lst_images = {
            ...
            R.drawable.great_barrier_reef,
            R.drawable.uluruayers_rock,
            R.drawable.kakadu_national_park,
            R.drawable.whitsunday_islands
    };
    ...
    private int[] lst_description = {
            R.string.sy_description,
            R.string.cairns_description,
            R.string.yulara_description,
            R.string.darwin_description,
            R.string.whitsunday_description
    ...
    private int[] lst_prices = {
            R.string.sy_price,
            R.string.cairns_price,
            R.string.yulara_price,
            R.string.darwin_price,
            R.string.whitsunday_price
    ...
    private int lst_contact = R.string.australia_contact;
    private int title = R.string.australia_label;
